...
const messagesInFrench = {
  ...
  city: "City :",
  state: "State :",
  koodacheriAddressone: "Koodacheri",
  koodacheriAddresstwo: " Paramathi Velur,Namakkal",
      ...
      <IntlProvider messages={messagesInFrench} defaultLocale="en">
        <div className="text-center pt-12 pb-10 lg:px-20 ">
          <h5 className="text-xl font-bold   bg-gradient-to-r from-blue-400 via-blue-200 to-blue-400 py-4">
            <FormattedMessage
              id="pattasukadaiHead"
              defaultMessage="  THOGAI MURUGAN BUILDERS PRESENTS THE THOGAI MURUGAN AVENUES @   Koodacheri, Paramathi Velur "
            />
          </h5>
        </div>
        <Bannerone />
