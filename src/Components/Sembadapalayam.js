...
const messagesInFrench = {
  sempadapalayamHead:
    "THOGAI MURUGAN BUILDERS PRESENTS THE THOGAI MURUGAN AVENUES @ Sempadapalayam, Karur",
  ...
  sempadapalayamNofplots:"94",
  sempadapalayamTypesofplots:"Normal flats & EWS Flats",
  propertyFeatures:"PROPERTY FEATURES",
  contactUs: "CONTACT US",

};
const Sembadapalayam = () => {
  return (
    <>
      <IntlProvider messages={messagesInFrench} locale="fr" defaultLocale="en">
        <div className="text-center pt-12 pb-10 lg:px-20 ">
          <h5 className="text-xl font-bold   bg-gradient-to-r from-blue-400 via-blue-200 to-blue-400 py-4">
            <FormattedMessage
              id="sempadapalayamHead"
              defaultMessage="  THOGAI MURUGAN BUILDERS PRESENTS THE THOGAI MURUGAN AVENUES @ Sempadapalayam, Karur "
            />
          </h5>
        </div>
        <Bannerone />
            ...
            <div className="lg:w-3/4 px-6">
              ...
              <div className="lg:px-80 py-2 text-base py-5">
                ...
                /> </span>
                  <span>
                  <FormattedMessage
                  id="sempadapalayamAddressone"
                  defaultMessage=" Kadai veethi, Sempadapalayam, "
                />
              ...
              <div className="lg:px-80 py-2 text-base py-5">
                <ul>
                  <li className="list-disc">Massive concrete Arch</li>
